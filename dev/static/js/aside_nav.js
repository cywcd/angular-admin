	...
	_createSubMenu: function(submenu,lihtml){
		...
		$(submenu).each(function(index,item){
			...
			if(item.submenu && item.submenu.length > 0) {
				...
				$(subLi).children('a').prepend('<img src="../img/common/blank.gif"/>');
...
$(document).on("click",".lev-2 li a",function(event){
	event.stopPropagation();
	$(this).parents(".aside_menu").find("li").removeClass("cur");
